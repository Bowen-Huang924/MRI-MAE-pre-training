...
if __name__ == '__main__':
    ...
    pre_list = [
        '/home/hsy/Desktop/pytorch_lane_det/checkpoints/llnet_3x3_vil100/vil100-eval-noise/JPEGImages',
        '/home/hsy/Desktop/pytorch_lane_det/checkpoints/llnet_3x3_vil100/vil100-eval-motion_blur/JPEGImages',
        '/home/hsy/Desktop/pytorch_lane_det/checkpoints/llnet_3x3_vil100/vil100-eval-scale/JPEGImages',
        '/home/hsy/Desktop/pytorch_lane_det/checkpoints/llnet_3x3_vil100/vil100-eval-shift/JPEGImages',
        '/home/hsy/Desktop/pytorch_lane_det/checkpoints/llnet_3x3_vil100/vil100-eval-rotate/JPEGImages',
    ]

    # json_dir_name is the path of Data_ROOT/Json
    json_dir_name = '/home/hsy/Documents/dataset/VIL100/Json'
    r_list = [1, 10, 100, 500, 1000]
    for pred_dir in pre_list:
        for r in r_list:
            pre_dir_name = '/home/hsy/Desktop/{}-{}-track'.format(os.path.basename(os.path.dirname(pred_dir)), r)
